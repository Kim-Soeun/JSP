...
<body>
	...
	<div class="container" align="center">
		...
		<%
			...
			MemberDTO dto = new MemberDAO().getMemberDTO(id, pw);
		...
		<div class="form-group">
			...
			name="pw" required autofocus placeholder="****"> <br>
		</div>

		<div class="form-group">
			<label for="inputPhone" class="sr-only">연락처 </label>
			<input type="text" class="form-control"
			name="phone" placeholder="<%=dto.getPhone() %>"> <br>
		</div>

		<div class="form-group">
			<label for="inputAddress" class="sr-only">주소 </label>
			<input type="text" class="form-control" 
			name="address" placeholder="<%=dto.getAddress() %>"> <br>
