		...
		<div class="container" align="center">
			<div class="col-md-4 col-md-offset-4">
				<div class="form-group">
					<label for="inputName" class="sr-only">아이디 </label> 
				...
				<div class="form-group">
					<label for="inputaImage" class="sr-only">사진 </label> 
					<input type="file" class="form-control" placeholder="사진" name="photoImage"
						id="inputImage" required> <br>
				</div>
