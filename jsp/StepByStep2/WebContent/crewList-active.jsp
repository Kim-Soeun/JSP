...
<%
	...
	List<CrewRecruitDTO> crewList = dao.selectNowRecruit();  // 모든 활동중인 단기크루 가져오기
	dao.close();
%>
												...
												<ul class="main-con-event">
													...
													<li><a href="#" onclick="#">		<!-- 클릭하면 크루 홈으로 이동 -->
															<span class="img" aria-hidden="true"><img
																...
																alt=""></span>
															<div class="event-txt">
																<p class="txt-01">마감일 </p><span>${crew.gatherDate}</span><!-- ${crew.created} -->
																<p class="txt-02">크루명 </p><span>${crew.crewName}</span><!-- ${crew.crewName} -->
																<p class="txt-02">소개(조건) </p><span>${crew.content}</span><!-- ${crew.content} -->
																<p class="txt-02">모집인원 </p><span>${crew.memberNum}</span>/<span>${crew.totalCount}(총 모집인원 값)</span><!-- ${crew.totalCount}/${crew.memberNum} -->
