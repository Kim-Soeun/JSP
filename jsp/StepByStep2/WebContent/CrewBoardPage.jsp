										...
										<div class="info-H">
											...
											<div class="wrap-gesi-btn">
												...
												<c:if test="${board.id eq UserId || UserId eq adminId}">
													<a href="DeleteBoardServlet?no=${board.no}&writerId=${board.id}&userId=${UserId}&crewName=${board.crewName}"><div class="gesi-btn edit">수정</div></a> 
									...
									<div class="content-area">
										...
										<div class="main-con3">
											...
											<c:if test="${not empty board.imgName}">
												<li><span class="img" aria-hidden="true">
												<img src="./resources/images/${board.imgName}" alt="${board.imgName}" alt=""></span></li>
											</c:if>
											<c:if test="${empty board.imgName}">
												<li><span class="img" aria-hidden="true">
												<img src="./resources/images/dog.png" alt="강아지사진" alt=""></span></li>
											</c:if>
												<!-- <li>
									...
									<div class="content-area">
										<div class="main-con2 act">
											...
											<ul>
												...
												<c:if test="<%=boo%>">
													<form action="./registerReplyLong.reply"  method="post" class="comment-box_frm">
														<input type="hidden" name="id"  value="<%=UserId%>" />
														<input type="hidden" name="b_no"  value="<%=no%>" />
														<textarea name="content" rows="3" cols="" placeholder="댓글을 입력해 주세요"
